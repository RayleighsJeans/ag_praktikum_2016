...
%         saveas(gcf,'spectrum','pdf');
    ...
    f = figure;
    hold on; box on;
    set(gca,'FontSize',26); plot(scan_spec,(-int_spectrum*1e-9+min(-int_spectrum*1e-9))/max(-int_spectrum*1e-9+min(-int_spectrum*1e-9)));
    ...
    ylabel('norm. intensity, a.u.');
            ...
            annotation(f,'textbox',...
                ...
                'String',{'He I','3^3S-2^3P','706,66 nm'},...
            ...
            annotation(f,'textarrow',[0.207907356661045 0.15008431703204],...
                ...
                'String',{'He I','3^3D-2^3P','587,65 nm'},...
                'HorizontalAlignment','center',...
                'Fontsize',18,...
                'FontName','L M Roman12');
            ...
            annotation(f,'textarrow',[0.529761438761308 0.569983136593592],...
                ...
                'String',{'He I','3^1D-2^1P','667,98 nm'},...
                'HorizontalAlignment','center',...
                'Fontsize',18,...
                'FontName','L M Roman12');
            ...
            annotation(f,'textarrow',[0.845314256604833 0.892074198988196],...
                ...
                'String',{'He I','3^1S-2^1P','728,31 nm'},...
                'HorizontalAlignment','center',...
                'Fontsize',18,...
                'FontName','L M Roman12');
