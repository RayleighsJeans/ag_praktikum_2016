...
loc_dat = 'D:\documents\git\ag_praktikum_2016\2016-06-29\Daten\';
loc_main = 'D:\documents\git\ag_praktikum_2016\2016-06-29\';
...
cd(loc_dat);
tmp = importdata('16Jun70001_RTO.dat');
tmp = tmp.data;
[n channel] = size(tmp);
time_volt = tmp(:,1);
...
for h=vert_nmb-1;
    ...
    for w=wvl_nmb-1;
        ...
        for l=loop_nmb;
            ...
            file_nmb = num2str(70000+l+15*w+540*h);
            nmb = l+15*w+540*h;
            disp(file_nmb);
